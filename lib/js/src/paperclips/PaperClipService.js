...
var KnexUtils = require('../utils/KnexUtils.js')
var PaperClip = require('./PaperClip.js')

var partial_arg = PaperClip.Decode[/* paperClip */ 0]

function handleResponse (param, param$1) {
  return KnexUtils.rejectIfEmpty(partial_arg, param, param$1)
}
...
function make (dataProvider) {
  var paperClips = Curry._1(
    dataProvider[/* postgres */ 0][/* fromTable */ 0],
    'paper_clips'
  )
  return /* record */ [
